...
const Chat = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await fetch('https://graphmind-api.onrender.com/chat', { // Change here for http://localhost:8000/chat
        method: 'POST',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: '20px',
          marginBottom: '15px',
          boxShadow: '0 0 30px rgba(0, 255, 0, 0.2), inset 0 0 50px rgba(0, 255, 0, 0.1)',
          overflowY: 'auto',
          overflowX: 'hidden',
          display: 'flex',
          flexDirection: 'column',
              ...
              chatState.messages.map((message, index) => (
                <div key={index} style={{
                  ...
                  <div style={{
                    ...
                    whiteSpace: 'pre-wrap',
                    color: message.role === 'user' ? '#00ffff' : '#00ff00',
                    textShadow: message.role === 'user' ? '0 0 5px #00ffff' : '0 0 5px #00ff00',
